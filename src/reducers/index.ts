import { EnthusiasmAction,UploadStatus, TableDisplay, VEPFileReceive, userInfoAction, AllAction } from '../actions';
// import {StoreState} from '../types/storeInterface';
import { StoreState, enthusiasm, fileUpload,tableFrameVCF, fileReceive, userInfo } from '../store';
